...
class Graph():
    ...
    def get_alias_edge(self, src, dst):
        ...
        Returns:
            [J,q]: The modified probability distribution after alias sampling
        ...
        for dst_nbr in sorted(G.neighbors(dst)):
            ...
            # If dtx = 1 ,i.e., if v,t and x are adjacent to each other 
            elif G.has_edge(dst_nbr, src):
                # Search bias = 1
                unnormalized_probs.append(G[dst][dst_nbr]['weight'])
            # If dtx = 2 ,i.e., x is at 2-hop distance from t
            else:
                # Search bias = 1/q
